...
export class AuthProvider {
    ...
    fetch_notifications(user_id) {
        ...
        return new Promise((resolve, reject) => {
            this.http.get(this.serviceurl + '/fetch_notifications/'+user_id, {
                    headers
                })
                .subscribe(res => {
                    loading.dismiss();
    ...
    update_new_mobile(data) {
        ...
        let body = 'id=' + data.id +'&new_mobile=' + data.new_mobile;


        return new Promise((resolve, reject) => {
            this.http.post(this.serviceurl+"update_new_mobile",body, {
                    headers
                })
                .subscribe(res => {
                    loading.dismiss();
    ...
    verify_new_mobile(data) {
        ...
        let body = 'id=' + data.id +'&new_mobile=' + data.new_mobile +'&otp=' + data.otp;


        return new Promise((resolve, reject) => {
            this.http.post(this.serviceurl+"verify_new_mobile",body, {
                    headers
                })
                .subscribe(res => {
                    loading.dismiss();
