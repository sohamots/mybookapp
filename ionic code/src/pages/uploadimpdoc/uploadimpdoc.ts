...
/**
 * Generated class for the UploadimpdocPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-uploadimpdoc',
  templateUrl: 'uploadimpdoc.html',
})
export class UploadimpdocPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad UploadimpdocPage');
  }
